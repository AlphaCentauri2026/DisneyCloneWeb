...
const MarvelMovies = () => {
  ...
  return (
    <>
      <div className="mb-12">
        <h2 className="text-white text-2xl font-bold mb-6 ml-4">Marvel Movies</h2>
